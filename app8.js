...
(async()=>{
  for(const src of ['app8a.js','app8b.js','app8c.js','app8d.js']){
    await new Promise((resolve,reject)=>{const s=document.createElement('script');s.src=src+'?v=20260904c1';s.onload=resolve;s.onerror=reject;document.body.appendChild(s)});
  }
